...
local tuxedo			= hsl(280, 36, 16)
local kamen				= hsl(280, 36, 18)
local midnight		= hsl(280, 36, 24)
local twilight		=	hsl(280, 36, 30)
local moonlight		= hsl(280, 36, 36)
local millennium	= hsl(280, 36, 42)
local silver			= hsl(280, 18, 48)
local diana				= hsl(280, 24, 60)
local crystal			= hsl(280, 60, 84)
local artemis			= hsl(280, 60, 90)
local nehellenia	= hsl(284, 36, 24)
local mugen				= hsl(284, 36, 36)
local deadmoon		= hsl(284, 36, 48)
local infinity		= hsl(284, 48, 72)
local moon				= hsl(324, 72, 60)
local usagi				= hsl(324, 84, 72)
local mercury			= hsl(216, 84, 72)
local ami					= hsl(216, 84, 84)
local mars				= hsl(357, 84, 60)
local rei					= hsl(357, 84, 72)
local jupiter			= hsl(72, 48, 60)
local makoto			= hsl(72, 48, 72)
local venus				= hsl(42, 84, 60)
local minako			= hsl(42, 84, 72)
local saturn			= hsl(260, 72, 72)
local hotaru			= hsl(260, 60, 78)
...
local theme = lush(function(injected_functions)
	...
	return {
		...
		Directory      { fg = saturn },
		DiffAdd        { bg = jupiter, fg = midnight, gui = "bold" },
		DiffChange     { bg = mercury, fg = midnight, gui = "bold" },
		DiffDelete     { bg = mars, fg = midnight, gui = "bold" },
		DiffText       { fg = moon, gui = "bold_italic" },
		EndOfBuffer    { fg = silver },
		TermCursor     { bg = diana, fg = midnight },
		TermCursorNC   { fg = diana },
		ErrorMsg       { bg = twilight, fg = rei },

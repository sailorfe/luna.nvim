...
local theme = lush(function(injected_functions)
	...
	return {
		...
		sym("@markup.heading.1.marker")({ fg = usagi, gui = "bold" }),
		sym("@markup.heading.2.marker")({ fg = ami, gui = "bold" }),
		sym("@markup.heading.3.marker")({ fg = rei, gui = "bold" }),
		sym("@markup.heading.4.marker")({ fg = makoto, gui = "bold" }),
		sym("@markup.heading.5.marker")({ fg = minako, gui = "bold" }),
		sym("@markup.heading.6.marker")({ fg = hotaru, gui = "bold" }),

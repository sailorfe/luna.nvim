...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    FloatTitle({ bg = bssm.surface, fg = bssm.saturn, gui = "bold" }),
    ...
    TabLineSel({ bg = bssm.overlay, fg = bssm.saturn, gui = "bold" }),

    Pmenu({ bg = bssm.surface, fg = bssm.text }),
    PmenuSel({ bg = bssm.overlay, fg = bssm.saturn, gui = "bold" }),
    PmenuKind({ bg = bssm.surface, fg = bssm.moon }),
    PmenuKindSel({ bg = bssm.overlay, fg = bssm.moon, gui = "bold" }),
    ...
    PmenuMatch({ fg = bssm.saturn, gui = "bold" }), -- 0.11 fuzzy match
    PmenuMatchSel({ fg = bssm.saturn, gui = "bold_underline" }),
    ...
    lCursor({ Cursor }),
    CursorIM({ Cursor }),
    TermCursor({ bg = bssm.saturn, fg = bssm.base }),
    ...
    Identifier({ fg = bssm.moon }),
    Function({ fg = bssm.saturn }),
    ...
    sym("@variable.builtin")({ fg = bssm.saturn, gui = "bold_italic" }),
    ...
    -- literals
    sym("@string")({ String }),
    sym("@string.escape")({ fg = bssm.saturn }),
    sym("@string.special")({ fg = bssm.saturn }),
    ...
    sym("@function.builtin")({ fg = bssm.moon, gui = "bold_italic" }),
    sym("@function.macro")({ Macro }),
    sym("@function.method")({ Function }),
    sym("@constructor")({ fg = bssm.saturn }),
    ...
    sym("@punctuation.special")({ fg = bssm.saturn }),
    ...
    sym("@markup.link.label")({ fg = bssm.saturn }),
    ...
    sym("@property")({ fg = bssm.saturn, gui = "italic" }), -- would love to change this
    ...
    sym("@lsp.type.parameter")({ fg = bssm.moon, gui = "italic" }),
    ...
    RenderMarkdownH1Bg({ bg = bssm.moon.darken(70).desaturate(70), fg = bssm.moon, gui = "bold" }),
    RenderMarkdownH2Bg({ bg = bssm.mercury.darken(70).desaturate(70), fg = bssm.mercury, gui = "bold" }),
    RenderMarkdownH3Bg({ bg = bssm.mars.darken(70).desaturate(70), fg = bssm.mars, gui = "bold" }),
    RenderMarkdownH4Bg({ bg = bssm.jupiter.darken(70).desaturate(70), fg = bssm.jupiter, gui = "bold" }),
    RenderMarkdownH5Bg({ bg = bssm.venus.darken(70).desaturate(70), fg = bssm.venus, gui = "bold" }),
    RenderMarkdownH6Bg({ bg = bssm.saturn.darken(70).desaturate(70), fg = bssm.saturn, gui = "bold" }),
